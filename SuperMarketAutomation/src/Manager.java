...
public class Manager extends JFrame {
	...
	public Manager() {
		...
		JButton btnEmployeeDb = new JButton("Employee \nDatabase");
		...
		JButton btnNewButton = new JButton("Inventory Database");
		...
		JButton btnNewButton_1 = new JButton("SalesStatistics");
		...
		btnNewButton_1.setBounds(459, 219, 176, 42);
		contentPane.add(btnNewButton_1);
		
		JButton btnLogout = new JButton("Logout");
		btnLogout.setBounds(510, 320, 84, 25);
